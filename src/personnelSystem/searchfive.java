...
public class searchfive {
	...
	public searchfive() throws ClassNotFoundException, SQLException {
		initialize();
	}
	private void initialize() throws ClassNotFoundException, SQLException {
		frame = new JFrame();
		frame.setTitle("查询5界面");
		...
		frame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
					...
					textPane.setText("用视图查询成绩高于x的员工");
					...
					textPane1.setText("x是你要输入的内容，请在下方输入");
					...
					textPane2.setText("成绩");
					textPane2.setBounds(35, 146,85, 32);
				   ...
				   String num3=textField2.getText();
					try {
						...
						JOptionPane.showMessageDialog(btnNewButton,"查询信息不能空填请重新输入！","Error", JOptionPane.ERROR_MESSAGE);
							...
							frame1=new JFrame("查询5结果");
							JTable table=PersonnelSystem.searchfive(num3);
